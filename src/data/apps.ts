...
export const copy = {
  es: {
    ...
    heroTitle: "Software simple. Ideas utiles.",
    heroText:
    ...
    contactText:
      "Soporte, dudas, colaboraciones o comentarios sobre algun desarrollo.",
    name: "Nombre",
    email: "Email",
    subject: "Asunto",
    message: "Mensaje",
...
export const apps: ProductApp[] = [
  {
    ...
    description: {
      es: "Un juego social +18 para parejas o amigos que convierte una reunion en una dinamica mas atrevida, directa y facil de iniciar.",
      en: "An adult social game for couples or friends that turns a gathering into a bolder, direct, easy-to-start dynamic.",
    },
    detail: {
      es: "Ya publicada en Google Play. Pensada para entrar rapido, elegir la intensidad y empezar sin menus innecesarios.",
  ...
  },
  {
    ...
    description: {
      es: "Una app de dinamicas para fiestas, reuniones familiares y grupos de todas las edades.",
  ...
  },
  {
    ...
    description: {
      es: "Un dashboard atractivo tipo wallet bancaria moderna para calcular tu finiquito o liquidacion y entender datos laborales clave.",
      en: "A modern banking-wallet-style dashboard that helps calculate severance or settlement and understand key labor data.",
    },
    detail: {
      es: "Una herramienta para tomar mejores decisiones: calcula, ordena conceptos y presenta la informacion laboral de forma clara y accionable.",
  ...
  },
  {
    ...
    description: {
      es: "El Duolingo del futbol: lecciones breves para aprender historia, reglas, estrategia y cultura del juego paso a paso.",
